...
# Terminal code is below.
# PRIVATE_IP_NEW=$(grep PrivateIpAddress info.json | head -n1 | cut -d'"' -f4)
# [ec2-user@ip-172-31-76-146 Task_1]$ sed "s/ec2-private_ip/${PRIVATE_IP_NEW}/" terraform.tf